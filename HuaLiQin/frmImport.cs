...
namespace HuaLiQin
{
    public partial class frmImport : Office2007Form
    {
        ...
        private bool Text2DB(DataTable dt)
        {
            ...
            HuaLiQin.DAL.t_ICItem dalICItem = new DAL.t_ICItem();
            HuaLiQin.DAL.PoInStock dalPOInStock = new DAL.PoInStock();
            HuaLiQin.DAL.PoInStockEntry dalPOInStockEntry = new DAL.PoInStockEntry();
            HuaLiQin.Model.t_ICItem mICItem = new Model.t_ICItem();
